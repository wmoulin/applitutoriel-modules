...
import { AdministrationSecteurService } from "src/services/data/adm/adm-secteur-service";
...
export class SupprimerSecteur extends RouteActionService<{ id: number }, AdministrationSecteurService> {
    execute(): Promise<any> {
...
export class ModifierSecteur extends RouteActionService<{ id: number }, AdministrationSecteurService> {
    execute(): Promise<any> {
