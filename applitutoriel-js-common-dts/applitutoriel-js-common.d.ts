...
declare module "applitutoriel-js-common/src/middleware/authentication-api" {
...
declare module "applitutoriel-js-common/src/actions/adm/adm-lst-actions" {
	...
	export class SupprimerSecteur extends RouteActionService<{
	    id: number;
	}, AdministrationSecteurServiceData> {
	    execute(): Promise<any>;
	}
...
declare module "applitutoriel-js-common/src/services/data/adm/adm-fpo-service-page" {
	/**
...
declare module "applitutoriel-js-common/src/services/data/adm/adm-secteur-service-data" {
...
declare module "applitutoriel-js-common/src/views/par/par-fpa/identite-tab" {
	...
	export class IdentiteTab extends TabContent<IdentiteTabProps, any> {
	     ...
	     */
	    setPartenaire(partenaire: PartenaireMetier, mode: string): void;
	    /**
...
declare module "applitutoriel-js-common/src/mock/services/data/auth/auth-service-data-mock-impl" {
	import { AuthService } from "applitutoriel-js-common/src/services/data/auth/auth-service";
	import { Response } from "superagent";
	import { Promise } from "hornet-js-utils/src/promise-api";
	/**
...
declare module "applitutoriel-js-common/src/mock/services/data/pro/fpo-service-data-mock-impl" {
	import { Promise } from "hornet-js-utils/src/promise-api";
	import { ProduitMetier } from "applitutoriel-js-common/src/models/pro/pro-mod";
	import { FicheProduitService } from "applitutoriel-js-common/src/services/page/adm/adm-fpo-service-page";
	/**
