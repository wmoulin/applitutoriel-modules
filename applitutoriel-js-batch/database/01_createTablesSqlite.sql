...
CREATE TABLE UTILISATEUR (
    ...
    , UTI_ENABLED INTEGER DEFAULT 0 NOT NULL );
...
CREATE TABLE PARTENAIRE (
    ...
    , SATISFACTION VARCHAR(500) NULL
    , PAR_DATE_CREATION TEXT  NULL
    , PAR_DATE_MODIFICATION TEXT  NULL
